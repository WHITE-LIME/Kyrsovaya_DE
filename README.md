...
При разработке информационной системы «ТехноСила» было проведено обследование деятельности магазина по следующим источникам:
...
Проектирование информационной системы «ТехноСила» начинается с этапа построения бизнес-процессов. Для описания бизнес-процессов в информационной системе «ТехноСила», используется диаграмма прецедентов.
...
В ходе выполнения курсового проекта средствами MySQL Workbench была разработана информационная система «Магазин ТехноСила», предназначенная для автоматизации работы директора магазина.
